...
class TextProcessor:
    """Klasse für die Verarbeitung von Text mit Gemini AI."""

    @staticmethod
    def generate_anschreiben(job_text, discipline, previous_cover_letter):
        """Generiert ein Anschreiben basierend auf Jobtext, Disziplin und bisherigen Anschreiben."""
        prompt = f"""**Rolle:**
    ...
    @staticmethod
    def rate_job_match(job_description, applicant_information):
    ...
    @staticmethod
    def format_job_description(html_code):
